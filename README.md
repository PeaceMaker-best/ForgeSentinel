...
ForgeSentinel is a local-first control plane between GitHub, coding harnesses, and an
...
ForgeSentinel keeps those responsibilities in a deterministic control plane:
...
ForgeSentinel works alongside coding models, CI, and GitHub project management. Its job
...
implementation. [RFC #70](https://github.com/PeaceMaker-best/ForgeSentinel/issues/70) records
...
`benchmark run` executes ForgeSentinelBench v0 entirely offline. Its versioned fixtures
...
GitHub writes use the configured maintainer identity. ForgeSentinel keeps model,
...
ForgeSentinel is at version 0.1. Configuration, schemas, and public interfaces may change
...
For using ForgeSentinel with existing coding agents, see the [assistance guide (中文)](docs/coding-agent-assistance.zh-CN.md) and [actual client pilot](docs/handoff-pilot-2026-09-05.zh-CN.md).
