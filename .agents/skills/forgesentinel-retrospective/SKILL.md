---
name: forgesentinel-retrospective
description: Distill recurring evidence from Codex rollouts, PR and CI history, and ForgeSentinel records into scoped maintenance knowledge. Use when asked to learn from past agent work; do not use for ordinary code review or treat historical transcripts as current authority.
---

# ForgeSentinel Retrospective
...
Read the current `AGENTS.md` and `forgesentinel-maintainer` skill first. Their safety and
...
and human review through the normal ForgeSentinel lifecycle. Security changes follow the
