    ...
    for proposal in proposals:
        ...
        items.append(
            _item(
                ...
                next_command=(
                    f"forgesentinel issue review {item_id} "
            ...
            items.append(
                _item(
                    **common,
                    ...
                    next_command=f"forgesentinel inspect {run_id}",
                )
            )
            continue
        if status == "ready":
            ...
            items.append(
                _item(
                    **common,
                    ...
                    next_command=f"forgesentinel follow-up {run_id}",
                )
            )
            continue
            ...
            items.append(
                _item(
                    **common,
                    ...
                    next_command=(
                        f"forgesentinel ci diagnose {normalized_repository} {pull_number}"
                    ),
                )
            )
            continue
        ...
        items.append(
            _item(
                **common,
                ...
                next_command=f"forgesentinel merge-decision {run_id}",
            )
        )
    ...
    for pull_number, pull in pulls.items():
        ...
        items.append(
            _item(
                ...
                next_command=(f"forgesentinel portfolio inspect {normalized_repository}"),
                pull_number=pull_number,
            )
        )
    ...
    if error:
        items.append(
            _item(
                ...
                next_command=f"forgesentinel inbox --repo {normalized_repository}",
            )
        )
    ordered = sorted(
        items,
