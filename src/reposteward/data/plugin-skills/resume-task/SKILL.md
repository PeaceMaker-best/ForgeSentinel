---
name: resume-task
description: Resume a ForgeSentinel task after a break, context compaction or a change of coding client. Recover requirements, decisions and evidence, then save a scoped checkpoint.
---
